import { createStyles, Container, Title, Text, rem, useMantineTheme } from '@mantine/core';
...
export function NothingFoundBackground() {
  ...
  return <Container className={classes.root}>
    <div className={classes.inner}>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 362 145" className={classes.image}>
        <path
