...
const countHandler: NextApiHandler = async (request, response) => {
  let news: any[] = [
    ...
    {
      "guid": "https://www.nytimes.com/2023/04/25/world/europe/a-grain-glut-leaves-some-eastern-european-countries-caught-between-solidarity-with-ukraine-and-survival.html",
      "url": "https://www.nytimes.com/2023/04/25/world/europe/a-grain-glut-leaves-some-eastern-european-countries-caught-between-solidarity-with-ukraine-and-survival.html",
      "title": "A grain glut leaves some Eastern European countries caught between solidarity with Ukraine and survival.",
      "date_published": "2023-04-25T09:52:14.000Z",
      "author": {
        "name": "Andrew Higgins"
      }
    },
  ...
  news = news.map<Article>((newsItem) => {
    return {
      name: newsItem.title,
      links: [newsItem.url],
